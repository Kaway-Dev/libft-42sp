...
- **Understanding concepts and edge cases** — Asking for explanations about libc function behavior, pointer manipulation, memory overlap, zero-length inputs, allocation failures, and integer edge cases.
